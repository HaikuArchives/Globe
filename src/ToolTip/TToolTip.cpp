...
const rgb_color kVIEW_COLOR	= {239, 239, 239, 255};	// view background color (light yellow)
const rgb_color kLIGHT_VIEW_COLOR = {239, 239, 239, 255}; // top left frame highlight
const rgb_color kDARK_VIEW_COLOR = {239, 239, 239, 255}; // bottom right frame highlight
...
void TToolTipView::AdjustWindow()
{
    ...
    wind->SetWorkspaces(fTip.WorkSpaces);
	// force an update
	Invalidate(Bounds());
}
